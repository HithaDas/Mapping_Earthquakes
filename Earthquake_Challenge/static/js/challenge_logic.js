...
// We create the satillite tile layer that will be the background of our map.
...
// Deliverable 3 - We create the dark tile layer that will be the background of our map.
...
// 1. Add a 2nd and 3rd layer group for tectonic plate and majaor earthquake data.
...
// Deliverable 2 Step 3 use the d3.json() callback method to make a call to the major earthquake data 
// from the GeoJSON Summary Feed for M4.5+ Earthquakes Links to an external site.for the Past 7 Days.
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
  ...
  // Deliverable 2 Step 7, pass the major earthquake data into the GeoJSON layer 
